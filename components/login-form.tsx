    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-balance">Welcome to StudioBook</h1>
          <p className="text-muted-foreground text-balance">Sign in to book your perfect recording studio</p>
        </div>
      </div>
